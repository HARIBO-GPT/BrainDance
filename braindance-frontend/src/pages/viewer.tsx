    ...
    return (
        <div>
            <div className="elementViewer" style={{height: "100vh", overflow:"scroll"}}>
                ...
                <div>
                    {[1,2,3,4,5,6,7].map(i => (
                        <Card style={{ backgroundColor: "#cedbf9", width: "45vh", margin: "0 auto", paddingBottom: "20px", marginBottom: "15px", borderRadius: "25px"}}>
                            <Card.Body>
                                <Card.Title style={{paddingTop:"22px", paddingLeft:"20px", textAlign:"left", fontWeight:"bold", fontSize:"26px", paddingBottom:"5px"}}>객체지향프로그래밍</Card.Title>
