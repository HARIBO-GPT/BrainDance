...
function viewer(){
    return (
        <div>
            <Grid container style={{paddingBottom: "20px", width: "45vh", margin: "0 auto"}}>
            <Grid item>
            ...
            <Card style={{ backgroundColor: "#cedbf9", width: "48vh", margin: "0 auto", paddingBottom: "20px", borderRadius: "25px"}}>
                <Card.Body>
